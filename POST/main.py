...
def view_patient(patient_id: str =Path(..., description='ID o fthe patient in the DB', example='P001')): #receieving path param here
...
def sort_patients(
    ...
    order: str = Query(
        'asc',
        description='Sort in ascending order or descending order'
    )
):
    ...
    # THESE MUST NOT BE INSIDE THE IF
    data = load_data()
...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    data[patient_id] = patient_pydantic_obj.model_dump(
        exclude=['id']
    )
...
@app.delete('/delete/{pateint_id:str}')
